...
class Settings(BaseSettings):
    ...
    pagemenot_az_timeout: int = 360  # seconds for az write/wait commands — must exceed az --timeout value used in runbooks (e.g. flexible-server wait --timeout 300 needs >300s here)
