...
2. GCP exec verification — validate Cloud Run ingress restore and Cloud SQL instance restart exec steps; confirm auto-resolve end-to-end for both
...
**Requirements:** AZ-01, AZ-02, AZ-03, AZ-04, AZ-05, AZ-06
**Depends on:** Phase 3
**Plans:** 5 plans
